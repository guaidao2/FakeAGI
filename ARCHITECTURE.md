...
- **完整循环接入**（`test_process_integration.py` + `run_process_selection_study.py`）：冒烟 6 项全过；n=30 预注册判定全过（H1：N2 2±0 vs N3 805±97；N1：fail 环境冻结 125 vs 在线 2——在线更新必要；零影响护栏 ask=0）。
