...
> 数字复核（2026-08-06 终审后）：E1-E11 判定全部通过（E3/E5 WARN 边界
> 如实记录——E5 反射无威胁感知、E3 随机方差大；单次跑数字波动——待
> 任务② seed 基建均值化定稿）。

| 实验 | 结果 |
|------|------|
| E1 新奇适应 | ✅ 通过（8x8→16x16，57-236 tick——波动待均值化） |
| E2 多驱动力冲突 | ✅ 通过 |
| E3 空间记忆利用 | ⚠️ WARN（改进 12-90% 方差） |
| E4 因果推理 | ✅ 通过（t=90~303 开关——波动待均值化） |
| E5 反事实选择 | ⚠️ WARN（反射无威胁感知——panic 时盲区） |
