...
- [x] **路线 C 多智能体社会**（`test_social.py`）— 双 AGI 共享世界：**边界通过（观察性）**——竞争冲突弱出现（1-4 次）但无生存优势（寿命 662=662 打平、seed7 单 AGI 更优 1519 vs 871）；多智能体不自动更好；seed 修复教训（缺 torch.manual_seed 初版伪通过）与每 seed 独立重置（security low）如实记录
