...
> - ⏳ **E14 组合回归诊断（77be49c）**：新模块（概念层+语言生成+SpeakerTrust）接入后 E14 重跑 **full 1.2 vs base 1.4 FAIL**——消融（E14_CONCEPT_DRIVE=0）确认根因=**概念驱动停留引导在威胁环境拖累**（开 1.2 vs 关 2.0——关闭恢复历史水平 OK full 2.0 vs base 1.4）——机制真实行为非 bug——概念引导在威胁区停留致暴露——**策略待适配（停留前威胁检查）**，下阶段课题
